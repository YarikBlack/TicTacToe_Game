...
public class Main {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			while(playerPossitions.contains(playerPos) || cpuPossitions.contains(playerPossitions)) {
				System.out.println("Possition Taken! Enter a correct Possition");
